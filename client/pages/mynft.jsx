...
export default function createNFT() {
  ...
  return (
    <>
      ...
      {currentAccount ? (
        <div>
          <section className="container max-w-screen-2xl mx-auto flex flex-col items-start justify-start md:flex-row py-24">
            <CreateNft />
            <div className="w-full mt-1  md:w-1/2 md:ml-8 md:mt-0  lg:w-2/3">
              <div className="flex items-start justify-between sm:w-full lg:w-2/3 xl:w-1/2 px-4">
                <div className="filter-btn" onClick={() => setItems(allItems)}>
                  All NFTs
                </div>
